...
$thisCatId = $arrClient [ 'AdminMenu' ][ 'id' ];
$thisCatName = $arrClient [ 'AdminMenu' ][ 'name' ]; 
$responseText = "<table id='table_list' ctrl='groups' cellspacing='0' cellpadding='0'>".
				"<tr class='column'><td>Admin Menu Name</td><td>Menu Controller</td><td>Priority</td><td></td></tr>";
