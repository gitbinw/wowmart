						...
						<div class="main">
                        	...
                        	<div class="row">
                                ...
                                <div class="col-right sidebar col-xs-12 col-sm-3">
                                	<div id="checkout-progress-wrapper" class="checkout_progress_wrap">
                                        <div class="block block-progress opc-block-progress last_block first">
                                            <div class="block-title">
                                                <strong><span>Your Items</span></strong>
                                                <span class="toggle"></span>
                                            </div>
                                            <div id="checkout-items-list" class="block-content">
                                                <ol class="mini-products-list checkout_items_list">
                                                    <?php 
                                                        if (isset($order_items->items) && count($order_items->items) > 0) { 
                                                            foreach($order_items->items as $item) { 
                                                    ?> 
                                                    <li class="item odd" id="key_prod_<?php echo $item['CartItem']['serial_no'];?>">	
                                                        <a href="/product/" title="<?php echo $item['CartItem']['name'];?>" class="product-image">		
                                                            <img src="/medias/products/00/00/36/dfafafafafa_0_xsmall.jpg" alt="<?php echo $item['CartItem']['name'];?>" width="65">	
                                                        </a>	
                                                        <div class="product-details">			
                                                            <p class="product-name"><a href=""><?php echo $item['CartItem']['name'];?></a></p>		
                                                            <div>			
                                                                <div class="qtyinput">				
                                                                    <span class="sqty"><?php echo $item['CartItem']['qty'];?> x </span>				
                                                ...
                                                <p class="subtotal">			
                                                    ...
                                                    <span class="price">$<?php echo $order_items->total;?></span>		
                                                </p>
                                             </div>
                                        </div>
                                    </div>
...
<script src="/js/opcheckout.js" type="text/javascript"></script>
