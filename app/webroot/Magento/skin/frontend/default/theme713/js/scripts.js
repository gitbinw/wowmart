jQuery(document).ready(function(){
	...
	/*************************************************************** Sidebar Accordion *********************************************************************/
		...
		jQuery('.sidebar .block .block-title, .col-main .block-layered-nav .block-title').on("click", function(){
 ...
 $(window).bind('load resize',function(){
  ...
  if(bodyWidth>=767){    
			...
			if(jQuery('.page').width() >= 734) {
				$('.products-grid li.item').each(function() {
				  ...
				  function(){
				    ...
				    //var pcPHeight = $(this).find('.wrapper-hover-hiden').outerHeight() + $(this).find('.ratings').outerHeight() + $(this).find('.product-thumbs').outerHeight() + 20;
				    $(this).parents('.products-grid li.item').addClass('hovered');
				    //$(this).parents('.products-grid li.item').css('margin-bottom',pcPHeight*-1)
				   // $(this).parents('.products-grid li.item').css('height', pcHeight + pcPHeight).css('margin-bottom',pcPHeight*-1),

				  },
				  function(){
				   $(this).parents('.products-grid li.item').removeClass('hovered');
				   //$(this).parents('.products-grid li.item').removeClass('hovered').css('margin-bottom',0);
	...
	function dropDown() 
	{
		...
		$(elementSlide).on('click', 'li a', function(e){
			e.stopPropagation();
