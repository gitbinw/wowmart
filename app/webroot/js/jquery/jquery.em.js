...
jQuery(function($) {
    ...
    $.em = $.extend({
         ...
         * @desc The default action is to trigger a global ?¡éa???¡°emchange?¡éa???? event.
         * You probably shouldn?¡éa??a?¡ét change this behaviour as other plugins may
        ...
        action: function() {
            ...
            // If the font size has changed since we last checked?¡éa???|
            if ( currentWidth != $.em.current ) {
                /**
                 * The previous pixel value of the user agent?¡éa??a?¡és font size. See
                 * $.em.current for caveats. Will initially be undefined until
                 * the ?¡éa???¡°emchange?¡éa???? event is triggered.
                 *
                 * @example $.em.previous;
                 * @result 16
                 *
                ...
                /**
                 * The current pixel value of the user agent?¡éa??a?¡és font size. As
    ...
    // Store the initial pixel value of the user agent?¡éa??a?¡és font size.
